...
function onLocation(location_id, location_name)
	...
	if loc_name=="Rice Beach 05 - Boss" and loc_type=="Boss" then
		local obj = Tracker:FindObjectForCode("rb_flooded")
		obj.Active = true
	end
	if loc_name=="Parsley Woods 32 - Normal Exit" and loc_type=="Normal Exit" then
		local obj = Tracker:FindObjectForCode("pw_drained")
		obj.Active = true
	end
	if loc_name=="Mt. Teapot 12 - Normal Exit" and loc_type=="Normal Exit" then
		print("Unlock mtt13")
